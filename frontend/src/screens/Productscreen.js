...
import { listDetailsProduct, productReview } from '../actions/productActions'
...
const Productscreen = ({ history, match }) => {
  ...
  useEffect(() => {
    ...
    dispatch(listDetailsProduct(match.params.id)
    );
  ...
  const submitHandler = (e) => {
    ...
    dispatch(productReview(match.params.id, { rating, comment }))
  }
